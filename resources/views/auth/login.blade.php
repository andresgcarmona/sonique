...
@section('main')
    <header id="auth-header" class="w-full text-center mb-4">
        <h1>
            <svg viewBox="0 0 1134 340" class="spotify-logo block mx-auto"><title>Spotify</title>
    ...
    <footer class="auth-footer mt-2 text-gray-500">
